...
export default function Footer() {
  return (
    <div className="second-container w-full py-20 bg-[#1C4A21] flex gap-x-20">
      {/* contact us */}
      <div className="flex flex-col gap-y-10">
        <img src="images/footer/landscop.png" loading="lazy" />
        ...
        <ul className="flex flex-col gap-y-5">
          <li className="flex items-center gap-x-2">
            ...
            <p className="text-white text-sm max-w-40">
          ...
          <li className="flex items-center gap-x-2">
            ...
            <a
              ...
              className="text-white text-sm max-w-40"
            >
        ...
        <div className="bg-white w-full rounded-full p-2 flex items-center gap-x-2  ">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <a href="tel:025123456789" className="text-lg text-secondary-color">
              025123456789
            </a>
          </div>
        </div>
      ...
      <div className="w-[282px] flex flex-col gap-y-10">
