...
export default function WhyUs() {
  return (
    <section className="why-us_bg">
      <div className="second-container relative w-full max-lg:w-[90%] max-lg:pb-5 max-lg:rounded-lg bg-white lg:h-[80%]">
        <div className="landscop-container flex flex-col gap-y-5 h-full">
          <img
          ...
          <div className="relative z-10 flex max-lg:flex-col max-lg:flex-col-reverse items-center justify-between -mt-10 px-10">
            <div className="text-black flex flex-col gap-y-10">
              ...
              <p className="text-[#0F3714CC] text-[15px] max-w-140">
                ما خلاقیت، دقت و کیفیت را به هر فضایی می‌آوریم. با اشتیاق به
                فضای سبز، رویاهای باغ را به واقعیت تبدیل می‌کنیم – به زیبایی، با
              ...
              <ul className="list-style-tick flex flex-col items-start gap-y-3 mr-6">
                ...
                <li className="!text-black">
                  ارائه خدمات جامع از طراحی تا اجرا
                </li>
              </ul>
            ...
            <img
              ...
              className="rounded-[25px] w-[600px] h-[507px] max-lg:hidden"
              loading="lazy"
            />

            <div className="rounded-[25px] bg-custom_bg_whyus lg:hidden" />
          </div>
          <div className="relative z-10 mt-20 !min-h-[438px] overflow-hidden flex max-lg:flex-col items-center rounded-[25px]">
            <OurExperiences />
            <OurCommitments />
            <ContactUsNow />
          </div>
