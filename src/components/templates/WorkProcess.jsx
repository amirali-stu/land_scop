...
export default function WorkProcess() {
  return (
    <section className="second-container w-full bg-[#0F3714] bg-custom overflow-hidden py-20">
      <div className="landscop-container overflow-hidden w-full flex flex-col gap-y-30">
        <div className="w-full flex max-lg:flex-col max-lg:gap-y-8 max-lg:items-start items-center justify-between">
          <div className="text-white flex flex-col items-start gap-y-4">
            ...
            <h2 className="text-[45px] max-lg:text-[34px]">
              پرورش ایده‌ها در فضاهای زندگی
            </h2>
            <p className="text-[#FFFFFFCC] text-[17px] max-w-155">
              اما با یک فرآیند گام به گام و واضح، محوطه‌سازی را آسان می‌کنیم.
              این فرآیند برای تبدیل ایده‌های شما به فضاهای سبز پررونق طراحی شده
              است.
            </p>
          </div>
        ...
        <div className="relative flex items-center gap-x-20 max-lg:hidden">
          <WorkProcessSteps />
          <img
